...
public class UserDao {
    ...
    private static final String SAVE_SQL = "INSERT INTO users_repository(name, birthday, email, password, role) " +
            "VALUES (?,?,?,?,?)";
    private static final String FIND_ALL = "SELECT * FROM users_repository";

    private static final String GET_BY_EMAIL_AND_PASSWORD_SQL =
            "SELECT * FROM users_repository WHERE email = ? AND password = ?";
